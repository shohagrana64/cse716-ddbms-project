...
CREATE TABLE `vehicleOrderInfo` (
  `vehicleOrderNumber` int(11) NOT NULL,
  `vehicleCode` varchar(15) NOT NULL,
  `orderedAmount` int(11) NOT NULL,
  `unitPrice` decimal(10,2) NOT NULL,
  `serialNumber` smallint(6) NOT NULL,
  PRIMARY KEY (`vehicleOrderNumber`,`vehicleCode`),
  FOREIGN KEY (`vehicleOrderNumber`) REFERENCES `vehicleOrders` (`vehicleOrderNumber`),
  FOREIGN KEY (`vehicleCode`) REFERENCES `vehicleInfo` (`vehicleCode`)
) ;
...
CREATE TABLE `vehicleOrders` (
  `vehicleOrderNumber` int(11) NOT NULL,
  `vehicleOrderDate` date NOT NULL,
  `requiredDate` date NOT NULL,
  `shippedDate` date DEFAULT NULL,
  `status` varchar(15) NOT NULL,
  `comments` text,
  `buyerNumber` int(11) NOT NULL,
  PRIMARY KEY (`vehicleOrderNumber`),
  FOREIGN KEY (`buyerNumber`) REFERENCES `buyers` (`buyerNumber`)
);
...
CREATE TABLE `paymentInfo` (
  ...
  PRIMARY KEY (`buyerNumber`,`accountNumber`),
  FOREIGN KEY (`buyerNumber`) REFERENCES `buyers` (`buyerNumber`)
) ;
...
CREATE TABLE `vehicleInfo` (
  `vehicleCode` varchar(15) NOT NULL,
  `vehicleName` varchar(70) NOT NULL,
  `vehicleType` varchar(50) NOT NULL,
  `vehicleScale` varchar(10) NOT NULL,
  `vehicleSeller` varchar(50) NOT NULL,
  `vehicleDescription` text NOT NULL,
  `availableQuantity` smallint(6) NOT NULL,
  `vehiclePrice` decimal(10,2) NOT NULL,
  `MSRP` decimal(10,2) NOT NULL,
  PRIMARY KEY (`vehicleCode`),
  FOREIGN KEY (`vehicleType`) REFERENCES `vehicleTypes` (`vehicleType`)
)  ;
...
CREATE TABLE `staffs` (
  ...
  FOREIGN KEY (`reportsTo`) REFERENCES `staffs` (`staffNumber`),
  FOREIGN KEY (`officeCode`) REFERENCES `warehouses` (`officeCode`)
) ;
...
CREATE TABLE `buyers` (
  ...
  `countryName` varchar(50) NOT NULL,
  `staffNumber` int(11) DEFAULT NULL,
  `creditLimit` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`buyerNumber`),
  FOREIGN KEY (`staffNumber`) REFERENCES `staffs` (`staffNumber`)
) ;

/*Data for the table `customers` */

insert  into `buyers`(`buyerNumber`,`buyerName`,`contactLastName`,`contactFirstName`,`phoneNumber`,`addressLine1`,`addressLine2`,`cityName`,`stateName`,`postalCode`,`countryName`,`staffNumber`,`creditLimit`) values
...
insert  into `staffs`(`staffNumber`,`lastName`,`firstName`,`extension`,`emailAddress`,`officeCode`,`reportsTo`,`designation`) values
...
insert  into `warehouses`(`officeCode`,`cityName`,`phoneNumber`,`addressLine1`,`addressLine2`,`stateName`,`countryName`,`postalCode`,`region`) values
...
insert  into `vehicleOrderInfo`(`vehicleOrderNumber`,`vehicleCode`,`orderedAmount`,`unitPrice`,`serialNumber`) values
...
insert  into `vehicleOrders`(`vehicleOrderNumber`,`vehicleOrderDate`,`requiredDate`,`shippedDate`,`status`,`comments`,`buyerNumber`) values
...
insert into `paymentInfo`(`buyerNumber`,`accountNumber`,`paymentDate`,`totalCost`) values
...
insert  into `vehicleTypes`(`vehicleType`,`description`,`htmlDescription`,`vehicleImage`) values
...
insert  into `vehicleInfo`(`vehicleCode`,`vehicleName`,`vehicleType`,`vehicleScale`,`vehicleSeller`,`vehicleDescription`,`availableQuantity`,`vehiclePrice`,`MSRP`) values
